...
import { Eye, UserPlus, Trash2, ClipboardPaste, LoaderCircle } from 'lucide-react';
...
function CargarFiscalesPageContent() {
                ...
                if (error.code === 'permission-denied') {
                    ...
                    errorEmitter.emit('permission-error', permissionError);
                     ...
                     toast({
                        ...
                        description: error.message || 'No se pudo guardar la lista de fiscales.',
                        variant: 'destructive',
                    });
                }
            })
                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    <CardDescription className="mt-1">
                                        Agrega nuevos fiscales para las elecciones de forma manual o masiva.
                                    </CardDescription>
                                </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <div className="space-y-6 lg:col-span-1">
                             <Card>
                                ...
                                <CardContent className="max-h-[calc(100vh-300px)] overflow-y-auto space-y-4">
